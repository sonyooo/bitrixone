...
<!-- SLIDER RED -->
		...
		<section class="section slider slider_catalog-<?=$class[$i]?> slider_<?=$class[$i]?> slider_catalog" id="<? echo $this->GetEditAreaId($item['ID']); ?>">
			<div class="slider__container container">
				<div class="slider__inner">
				<div class="slider__text">
					<div class="slider__nav">
						<div class="slider__pagination slider__pagination_catalog-<?=$class[$i]?> banner-pagination"></div>
						<div class="slider__arrows">
							<div class="slider__prev slider__prev_catalog-<?=$class[$i]?> slider__arrow">
							...
							<div class="slider__next slider__next_catalog-<?=$class[$i]?> slider__arrow">
							<svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
					...
					<div class="swiper-slide slider__item slider__item_text">
						<div class="slider__text-inner slider__text-inner_<?=$class[$i]?>">
						...
						<div class="slider__buttons">
							<a href="<?=$item['SECTION_PAGE_URL']?>" class="slider__button slider__button_first button button_transparent">
							Перейти в каталог
							</a>
				...
				<div class="slider__image">
					...
					<div class="swiper-slide slider__item slider__item_image">
						<div class="slider__image-outer">
							<div class="slider__image-block slider__image-block_<?=$class[$i]?>" style="background-image: url(<?=$item['PICTURE']['SRC']?>)">
							</div>
						</div>
					</div>
					<div class="swiper-slide slider__item slider__item_image">
...
<? elseif($arResult['SECTION']['ID']==1 || $arResult['SECTION']['ID']==3 || $arResult['SECTION']['ID']==4):?>
<? foreach($arResult['SECTIONS'] as $item):?>
	<div class="container">
			<div class="inner-top">
				...
				<div class="inner__info">
					...
					<h1 class="inner__title">Весы и весовая электроника Уралвес</h1>
					<div class="inner__desc">
						Общий SEO текст про продукцию предприятия. Весы автомобильные пользуются высоким спросом на всех предприятиях, осуществляющих перемещение и учет груза, преимущественно сырья, с помощью автомобильного транспорта.
					</div>
		...
		<div class="container inner inner_wide">
			<!-- CONTENT -->
			<div class="inner__content">
				<div class="inner__card-list card-list">
					<div class="card-list__item">
						<!-- CARD -->
						<a href="<?=$item['SECTION_PAGE_URL']?>" class="card card_img-cover">

							<div class="card__img-wrap">
								<img src="<?=SITE_TEMPLATE_PATH?>/img/product-1.jpg" alt="" class="card__img">
							</div>
					...
					<div class="card-list__item">
						<!-- CARD -->
						<a href="#" class="card card_img-cover">

							<div class="card__img-wrap">
								<img src="<?=SITE_TEMPLATE_PATH?>/img/product-2.jpg" alt="" class="card__img">
							</div>
					...
					<div class="card-list__item">
						...
						<a href="#" class="card card_img-cover">
							...
							<div class="card__img-wrap">
								<img src="<?=SITE_TEMPLATE_PATH?>/img/product-3.jpg" alt="" class="card__img">
							</div>

							<div class="card__main-info">
								<h4 class="card__title">Платформенные автомобильные весы</h4>
				...
				<div class="wysiwyg inner__wysiwyg">
					<p><b>Весы автомобильные пользуются высоким спросом на всех предприятиях, осуществляющих перемещение и учет груза, преимущественно сырья, с помощью автомобильного транспорта. Прежде всего, крупногабаритные автовесы востребованы в сельском хозяйстве, на добывающих предприятиях, при производстве строительных материалов. Также автомобильные весы применяются для учета внутреннего грузооборота, приемке и отпуске материалов и готовой продукции.</b></p>
					<p>Весы автомобильные пользуются высоким спросом на всех предприятиях, осуществляющих перемещение и учет груза, преимущественно сырья, с помощью автомобильного транспорта. Прежде всего, крупногабаритные автовесы востребованы в сельском хозяйстве, на добывающих предприятиях, при производстве строительных материалов. Также автомобильные весы применяются для учета внутреннего грузооборота, приемке и отпуске материалов и готовой продукции.</p>
					<p>Приобретение автомобильных весов – важный шаг на пути к повышению экономической эффективности любого предприятия, поэтому к выбору такого средства измерения как автомобильные весы необходимо отнестись со всей серьезностью. Весы для взвешивания автомобилей лучше всего приобретать у непосредственного производителя, убедившись в том, что автовесы соответствуют требования ГОСТа и имеют сертификат. Наличие у производителя сертификата на весы является гарантией их надежности и точности.</p>
					<p>Автомобильные весы УРАЛВЕС внесены в Госреестр средств измерений и имеют Сертификат соответствия. Приобретение весов в нашей компании станет выгодным вложением в развитие вашего бизнеса.</p>
				</div>
...
?>
	<div class="container">
			...
			<div class="inner-top">
					...
					<h1 class="inner__title">Подкладные автомобильные весы</h1>
					<div class="inner__desc">
						Подкладные автовесы – это малогабаритный тип электронных автомобильных весов, мобильный, простой в установке и оптимально подходящий для оперативного контроля веса груженого и порожнего автотранспорта. Взвешивание происходит при поочередном наезде осей автомобиля на платформы весов. Подкладные весы УРАЛВЕС предназначены для измерения нагрузки на ось, также при технологическом учете возможно определение полной массы автомобиля суммированием веса осей
					</div>
					<div class="inner__info-bottom">
		...
		<div class="container inner">
			...
			<div class="inner__content">
				...
				<div class="inner__card-list card-list card-list_inner">
					<div class="card-list__item">
						<!-- CARD -->
						<a href="<?=$item['SECTION_PAGE_URL']?>" class="card card_img-cover">
