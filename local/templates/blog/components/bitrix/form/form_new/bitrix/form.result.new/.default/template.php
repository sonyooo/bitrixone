...
?>
	...
	<?
		...
		if($arQuestion['STRUCTURE'][0]['FIELD_ID'] == 5) {
...
?>
	<div class="form__input">
		<button class="form__button button" <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" value="<?=htmlspecialcharsbx(trim($arResult["arForm"]["BUTTON"]) == '' ? GetMessage("FORM_ADD") : $arResult["arForm"]["BUTTON"]);?>" >Отправить</button>
	</div>
	</div>
