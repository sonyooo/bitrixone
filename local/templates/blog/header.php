...
<header class="header">
        ...
        <?$APPLICATION->IncludeComponent("bitrix:main.include", "email", Array(
	"AREA_FILE_RECURSIVE" => "Y",	// Рекурсивное подключение включаемых областей разделов
		...
		"AREA_FILE_SUFFIX" => "email",	// Суффикс имени файла включаемой области
...
<?$APPLICATION->IncludeComponent("bitrix:main.include", "phone", Array(
	"AREA_FILE_RECURSIVE" => "Y",	// Рекурсивное подключение включаемых областей разделов
		"AREA_FILE_SHOW" => "sect",	// Показывать включаемую область
		"AREA_FILE_SUFFIX" => "phone",	// Суффикс имени файла включаемой области
		"EDIT_TEMPLATE" => "",	// Шаблон области по умолчанию
		"COMPONENT_TEMPLATE" => ".default"
	),
	false
